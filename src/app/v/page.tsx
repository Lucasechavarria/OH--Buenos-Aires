...
function ValidationContent() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-onyx flex flex-col items-center justify-center text-white gap-4">
        <Loader2 className="w-8 h-8 text-gold-heritage animate-spin" />
        <p className="text-[10px] uppercase tracking-[0.3em] text-gold-heritage">Verificando Integridad...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-onyx flex items-center justify-center p-6 font-sans">
      <div className="max-w-md w-full bg-white/5 backdrop-blur-xl border border-gold-heritage/20 rounded-[3rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
        {/* Decorativo */}
        <div className="absolute top-0 right-0 w-32 h-32 bg-gold-heritage/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-gold-heritage text-[10px] font-bold uppercase tracking-[0.4em] mb-10">
            Oh! Buenos Aires • Verificación
          </p>

          <div className="space-y-6 text-left">
            <div className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
              <Store className="w-5 h-5 text-gold-heritage" />
              <div>
            ...
            <div className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
              <Tag className="w-5 h-5 text-gold-heritage" />
              <div>
            ...
            <div className="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/5">
              <Calendar className="w-5 h-5 text-gold-heritage" />
              <div>
          ...
          <div className="mt-12 pt-8 border-t border-white/5 flex flex-col items-center gap-6">
            {isValid && (
              <button
                ...
                disabled={redeeming}
                className="w-full h-16 bg-gold-metallic text-onyx font-bold uppercase tracking-[0.3em] text-[11px] rounded-2xl shadow-xl shadow-gold-heritage/20 hover:scale-105 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
              >
