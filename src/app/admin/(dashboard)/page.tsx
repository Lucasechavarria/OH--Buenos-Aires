    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white/5 backdrop-blur-md p-6 rounded-2xl border border-gold-heritage/20 shadow-xl transition-all hover:border-gold-heritage/40">
          ...
          <a href="/admin/subscribers" className="text-gold-metallic text-[10px] font-bold uppercase tracking-[0.2em] hover:text-gold-shine flex items-center gap-1">Ver Lista &rarr;</a>
        </div>
      </div>
    </div>
  );
