      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-xl">
             <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-celeste-oh mb-4 block">Novedades</span>
             <h2 className="text-4xl md:text-5xl font-serif text-onyx leading-tight">Oh! News</h2>
          </div>
          <Link href="/news" className="group flex items-center gap-3 text-[10px] font-bold uppercase tracking-[0.4em] text-onyx hover:text-celeste-oh transition-all mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <Link key={news.id} href="/news" className="group relative overflow-hidden rounded-3xl block shadow-xl border border-onyx/5">
               ...
               <div className="absolute bottom-0 left-0 p-8 text-white">
                  <div className="flex items-center gap-3 text-[9px] font-bold uppercase tracking-widest mb-4">
                     <span className="px-2 py-1 bg-brand-accent text-white rounded-sm">{news.category}</span>
                     <span>{news.date}</span>
                  </div>
          ...
          <div className="space-y-8 pl-0 md:pl-10">
             ...
             <div className="flex gap-4">
                <div className="h-1 w-12 bg-celeste-oh" />
