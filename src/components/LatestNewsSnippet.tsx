...
export default function LatestNewsSnippet() {
  return (
    <section id="news" className="py-24 px-6 bg-background border-y border-white/5">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-xl">
             ...
             <h2 className="text-4xl md:text-5xl font-serif text-white leading-tight">Oh! News</h2>
          </div>
          <Link href="/news" className="group flex items-center gap-3 text-[10px] font-bold uppercase tracking-[0.4em] text-white hover:text-gold-heritage transition-all mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 pl-0 md:pl-10">
             <p className="text-alabaster/60 text-lg leading-relaxed font-medium italic">
