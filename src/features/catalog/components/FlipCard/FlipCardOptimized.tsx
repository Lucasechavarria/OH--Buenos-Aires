        ...
        <div className="absolute inset-0 h-full w-full rounded-2xl bg-onyx p-8 backface-hidden rotate-y-180 flex flex-col justify-between text-alabaster shadow-2xl border border-gold-heritage/30">
          ...
          <div className="space-y-4">
            ...
            {brand.activePromotions && brand.activePromotions.length > 0 && (
              <Button
                className="w-full h-12 bg-gold-metallic hover:scale-105 transition-transform text-onyx font-bold tracking-[0.3em] text-[10px] uppercase border-none shadow-gold-glow font-sans flex items-center justify-center cursor-pointer disabled:opacity-50"
