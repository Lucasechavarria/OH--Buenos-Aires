...
const NAV_ITEMS = [
  { label: "Locales", href: "/#boutiques" },
  { label: "Promociones", href: "/promociones" },
  { label: "Oh! News", href: "/news" },
  ...
  return (
    <header 
      className={`fixed top-0 z-50 w-full transition-all duration-700 ${
        isScrolled 
          ? "bg-white/95 backdrop-blur-2xl border-b border-gold-heritage/30 shadow-2xl py-2" 
